...
export const MAGMA_CARDS: CardDef[] = [
  {
    ...
    stats: U({ hp: 520, dmg: 58, speed: 0.095, atkCd: 8, range: 1.1, canHitAir: true, heavy: true, colossal: true, radius: 0.55 }),
  ...
  },
  {
    ...
    stats: U({ hp: 235, dmg: 40, speed: 0.17, atkCd: 4, radius: 0.4 }),
  ...
  },
  {
    ...
    stats: U({ hp: 105, dmg: 30, speed: 0.27, atkCd: 4, flying: true, canHitAir: true, radius: 0.32 }),
  ...
  },
  {
    ...
    stats: U({ hp: 180, dmg: 24, speed: 0.21, atkCd: 4, radius: 0.32 }),
  ...
  },
  {
    ...
    stats: U({ hp: 150, dmg: 28, speed: 0.17, atkCd: 4, range: 1.05, radius: 0.36 }),
  ...
  },
  {
    ...
    stats: U({ hp: 52, dmg: 9, speed: 0.2, atkCd: 4, radius: 0.24, count: 3, formation: 'line' }),
...
export const OASIS_CARDS: CardDef[] = [
  {
    ...
    stats: U({ hp: 530, dmg: 56, speed: 0.1, atkCd: 8, range: 1.1, canHitAir: true, heavy: true, radius: 0.52 }),
  ...
  },
  {
    ...
    stats: U({ hp: 240, dmg: 34, speed: 0.22, atkCd: 4, heavy: true, radius: 0.42 }),
  ...
  },
  {
    ...
    stats: U({ hp: 104, dmg: 18, speed: 0.26, atkCd: 4, flying: true, canHitAir: true, radius: 0.34 }),
  ...
  },
  {
    ...
    stats: U({ hp: 155, dmg: 27, speed: 0.27, atkCd: 4, radius: 0.34, count: 2, formation: 'pair' }),
  ...
  },
  {
    ...
    stats: U({ hp: 290, dmg: 19, speed: 0.14, atkCd: 4, radius: 0.38, reflectPct: 0.2 }),
    blurb: 'Defensive tank. A fifth of every melee blow it takes is returned to the attacker as a face full of quills.',
    hue: 160,
  },
  {
    id: 'beetles', name: 'Bombardier Beetles', title: 'Chemical Artillery', cost: 4, kind: 'unit', species: 'beetles',
    stats: U({ hp: 140, dmg: 20, speed: 0.14, atkCd: 8, range: 3.2, ranged: true, canHitAir: true, radius: 0.36 }),
